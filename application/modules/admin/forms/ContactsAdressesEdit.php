...
class Contents_Form_ContactsAdressesEdit extends Sunny_Form
{
	public function init()
	{
		...
		$main[] = 'adress_uk';
		$this->addElement('textarea', 'adress_uk', array(
			'label' => 'Адрес (Укр)'
		));

		$main[] = 'adress_ru';
		$this->addElement('textarea', 'adress_ru', array(
			'label' => 'Адрес (Рус)'
		));

		$main[] = 'adress_en';
		$this->addElement('textarea', 'adress_en', array(
			'label' => 'Адрес (Англ)'
		));
