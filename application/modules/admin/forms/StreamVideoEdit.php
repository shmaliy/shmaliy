...
class Contents_Form_StreamVideoEdit extends Sunny_Form
{
protected $_contentsGroupsId;
	...
	public function init()
	{
		...
		$main[] = 'stream_file_url';
		$this->addElement('text', 'stream_file_url', array(
			'label' => 'Адрес файла потокового видео'
		));
